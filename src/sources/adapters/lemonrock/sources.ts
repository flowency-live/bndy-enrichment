...
export const LEMONROCK_SOURCES: GigSource[] = [
  ...
  { ...common, id: 'lemonrock-artist-index', name: 'Lemonrock national artist index', url: 'https://www.lemonrock.com/allbands.php' },
  ...
  { ...common, id: 'lemonrock-future-reconcile', name: 'Lemonrock national future-gig reconcile', url: 'https://www.lemonrock.com/gigsbycounty.php' },
